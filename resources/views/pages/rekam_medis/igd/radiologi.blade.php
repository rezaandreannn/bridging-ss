    ...
    <center>
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td width="180">:
                    {{ str_replace(',', '', $data->rad) }} 
                    @if($data->BAGIAN_RADIOLOGI !== null)
                        ,{{ $data->BAGIAN_RADIOLOGI }}
                    @endif
                </td>
            </tr>
        </table>
        ...
        <table width="100%">
            <tr>
                <td></td>
                <td class="ttd" style="text-align: left;">Metro, {{ date('d-m-Y', strtotime($data->MDD)) }}</td>
            </tr>
            <tr>
                <td></td>
                <td style="float: left;">
            ...
            <tr>
                <td></td>
                <td style="text-align: left;">{{ $data->Nama_Dokter ?? ''}}</td>
            </tr>
        </table>
    </center>
</body>
