...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form action="{{ route('operasi.signin.store') }}" method="POST">
            @csrf
                {{-- Data UMUM --}}
                <div class="card mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pemasangan_implant" id="pemasangan_implant1" value="1">
                                        <label class="form-check-label" for="pemasangan_implant1">
                                            Ya
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pemasangan_implant" id="pemasangan_implant2" value="0" checked>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="kehilangan_darah" id="kehilangan_darah1" value="1">
                                        <label class="form-check-label" for="kehilangan_darah1">
                                            Ya
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="kehilangan_darah" id="kehilangan_darah2" value="0" checked>
