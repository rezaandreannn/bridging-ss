        ...
        <div class="section-body">
            <div class="card">
                <div class="card-header">
                    <a href="{{route('ttd-perawat.create')}}" class="btn btn-sm btn-primary">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" id="table-1">
                            ...
                            <tbody>
                                ...
                                @foreach ($ttdPerawats as $ttd)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $ttd->nama_perawat }}</td>
                                    <td>
                                        <a href="#" data-toggle="modal" data-target="#gambarModal{{ $ttd->id }}">Lihat Tanda Tangan</a>
                                    </td>
                                    <td width="15%">
                                        <form id="delete-form-{{$ttd->id}}" action="{{ route('ttd-perawat.destroy', $ttd->id) }}" method="POST" style="display: none;">
                                            @method('delete')
                                            @csrf
                                        </form>
                                        ...
                                        <a href="{{ route('ttd-perawat.edit', $ttd->id)}}" class="btn btn-sm btn-warning"><i class="fas fa fa-edit"></i> Edit</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Tanda Tangan Perawat - {{ $ttd->nama_perawat }}</h5>
            ...
            <div class="modal-body text-center">
                ...
                <img src="{{ asset('storage/ttd/perawat/' . $ttd->ttd_perawat) }}" class="img-fluid" alt="Gambar Pengguna">
            </div>
