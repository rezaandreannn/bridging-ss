    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Diagnosis Medis</div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-add-diagnosis-medis">
                        <i class="fas fa-plus"></i> Diagnosis Medis
                    </button>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table-striped table" id="table-1">
                            <thead>
                                <tr>
                                    <th scope="col">No</th>
                                    <th scope="col">Nama Diagnosis Medis</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->nama_diagnosis_medis }}</td>
                                    ...
                                    <td width="25%">
                                        ...
                                        <form id="delete-form-{{$item->id}}" action="{{ route('diagnosisMedis.destroy', $item->id) }}" method="POST" style="display: none;">
                                            @method('delete')
                                            @csrf
                                        </form>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Diagnosis Medis</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('diagnosisMedis.update', $item->id) }}" method="POST">
                    @csrf
                    @method('put')
                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_diagnosis_medis" class="form-control @error('nama_diagnosis_medis')  is-invalid @enderror" value="{{$item->nama_diagnosis_medis}}">
                            @error('nama_diagnosis_medis')
...
<div class="modal fade" id="modal-add-diagnosis-medis">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Diagnosis Medis</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
            <form action="{{ route('diagnosisMedis.store') }}" method="POST">
            @csrf
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Nama Diagnosa</label>
                            <input type="text" name="nama_diagnosis_medis" class="form-control @error('nama_diagnosis_medis')  is-invalid @enderror">
                            @error('nama_diagnosis_medis')
                            <span class="text-danger" style="font-size: 12px;">
                                {{ $message }}
                            </span>
