        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    ...
                    <form id="myForm" action="{{ route('kondisiPulang.rujukInternalUpdate', $rujuk->FS_KD_REG) }}" method="POST">
                        @csrf
                        @method('put')
                    <div class="card card-secondary">
                        <div class="card-header card-success">
                            <h4 class="card-title">EDIT SURAT RUJUKAN INTERNAL</h4>
                        </div>
                        <!-- include form -->
                        <div class="card-body">
                            <!-- <div class="row"> -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="FS_TUJUAN_RUJUKAN" id="FS_TUJUAN_RUJUKAN" class="form-control select2">
                                            ...
                                            <option value="{{ $dokter->kode_dokter }}" {{ $rujuk->FS_TUJUAN_RUJUKAN == $dokter->kode_dokter ? 'selected' : '' }}>
                                                {{ $dokter->nama_dokter }}
                                            </option>
                                            @endforeach
                                        </select>
