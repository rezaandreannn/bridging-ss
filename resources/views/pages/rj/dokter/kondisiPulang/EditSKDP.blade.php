        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    ...
                    <form id="myForm" action="{{ route('kondisiPulang.UpdateSkdpRS',$biodata->NO_REG) }}" method="POST">
                        @csrf
                        @method('put')
                      {{-- surat menyurat  --}}
                      <div class="card card-success">
                        ...
                        <div class="card-body card-khusus-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    <input type="date" name="FS_SKDP_KONTROL" class="form-control" id="tgl_kontrol_berikutnya" value="{{$skdp->FS_SKDP_KONTROL ?? ''}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label>Tanggal Expired Rujukan Faskes : </label>
                                <div class="input-group mb-3">
                                    <input type="date" name="FS_SKDP_FASKES" id="FS_SKDP_FASKES" value="{{ $skdp->FS_SKDP_FASKES ?? ''}}" class="form-control" value="{{$skdp->FS_SKDP_FASKES ?? ''}}">
                                </div>
                            </div>
                            <div class="col-md-6">
