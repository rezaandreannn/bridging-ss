...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form action="{{ route('store.SKD') }}" method="POST">
            @csrf
            <!-- components biodata pasien by no reg -->
                <div class="card mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="PEKERJAAN" value="{{ old('PEKERJAAN') }}" id="PEKERJAAN" class="form-control" placeholder="-">
                                </div>
                                @error('sekolah')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="TUJUANSURAT" placeholder="Masukkan Tujuan Surat ..." value="{{ old('TUJUANSURAT') }}" id="TUJUANSURAT" class="form-control">
                                    @error('TUJUANSURAT')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="FS_BB" value="{{ old('FS_BB') }}" id="FS_BB" placeholder="Masukkan Berat Badan ..." class="form-control" placeholder="-">
                                    @error('FS_BB')
                                    <span class="text-danger" style="font-size: 12px;">
                                        {{ $message }}
                                    </span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="FS_TB" value="{{ old('FS_TB') }}" id="FS_TB" placeholder="Masukkan Tinggi Badan ..." class="form-control" placeholder="-">
                                    @error('FS_TB')
                                    <span class="text-danger" style="font-size: 12px;">
                                        {{ $message }}
                                    </span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="FS_TD" value="{{ old('FS_TD') }}" placeholder="Masukkan Tensi Darah ..." id="FS_TD" class="form-control" placeholder="-">
                                    @error('FS_TD')
                                    <span class="text-danger" style="font-size: 12px;">
                                        {{ $message }}
                                    </span>
