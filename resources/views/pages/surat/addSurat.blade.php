...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form action="{{ route('store.suratSakit') }}" method="POST">
            @csrf
            <!-- components biodata pasien by no reg -->
                <div class="card mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sekolah" value="{{ old('sekolah') }}" id="sekolah" class="form-control" placeholder="-">
                                </div>
                                @error('sekolah')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="jumlahhari" id="jumlahhari" value="{{ old('jumlahhari') }}" placeholder="masukkan hanya angka" class="form-control @error('tb') is-invalid  
                                        @enderror">
